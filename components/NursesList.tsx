        ...
        <section id="nurses" className="py-24 bg-zinc-50">
            <div className="container mx-auto px-4 md:px-6">
                ...
                <div className={`grid ${getGridColsClass()} gap-8 transition-all duration-500`}>
                    {nurses.map((nurse) => (
                        <div key={nurse._id} className={`group bg-white rounded-3xl overflow-hidden border border-black/5 hover:border-black/20 transition-all duration-500 shadow-sm hover:shadow-xl ${columns === 1 ? 'flex flex-col md:flex-row' : ''}`}>
                            {/* Image Container */}
                                ...
                                <div className="flex-1 p-8 flex flex-col justify-center">
                                    <div className="space-y-4">
                                        ...
                                        <div className="flex items-center gap-4 pt-2">
                                            <button className="px-8 py-4 bg-black text-white rounded-full font-bold hover:bg-gray-800 transition-all flex items-center gap-3 shadow-lg shadow-black/10">
                                                Book Appointment <Icon icon="solar:calendar-linear" className="text-xl" />
                                            </button>
                                            <button className="h-14 w-14 border border-black/10 rounded-full flex items-center justify-center hover:bg-black hover:text-white transition-all group/info">
