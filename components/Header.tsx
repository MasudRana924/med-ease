        ...
        >
            <div className="container mx-auto px-4 md:px-6 h-20 flex items-center justify-between">
                ...
                <Link href="/" className="flex items-center gap-2 group">
                    <span className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-cyan-500 dark:from-white dark:to-gray-300 tracking-tight">
                        Med-Ease
                    </span>
                </Link>
                ...
                <div className="flex items-center gap-5">
                    <Link href="/cart" className="relative group">
                        <div className="p-2.5 rounded-full hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors">
                            <Icon icon="solar:cart-large-2-linear" className="text-xl text-gray-700 dark:text-gray-300 group-hover:text-blue-600 transition-colors" />
                        </div>
                        {cart.length > 0 && (
                    ...
                    <Link href="/wishlist" className="relative group">
                        <div className="p-2.5 rounded-full hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors">
                            <Icon icon="solar:heart-linear" className="text-xl text-gray-700 dark:text-gray-300 group-hover:text-rose-500 transition-colors" />
                        </div>
                        {wishlist.length > 0 && (
                        ...
                        <div className="flex items-center gap-3 pl-4 border-l border-gray-200 ml-2 dark:border-gray-700">
                            <div className="flex items-center gap-2">
                                <div className="w-8 h-8 rounded-full bg-gradient-to-tr from-blue-100 to-cyan-100 flex items-center justify-center">
                                    <Icon icon="solar:user-circle-linear" className="text-xl text-blue-600" />
                                </div>
                    ...
                    >
                        <Icon icon={isMenuOpen ? "solar:close-circle-linear" : "solar:hamburger-menu-linear"} className="text-2xl text-gray-700 dark:text-gray-300" />
                    </button>
